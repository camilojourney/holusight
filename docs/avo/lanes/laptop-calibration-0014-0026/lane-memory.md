# Lane memory — laptop-calibration-0014-0026

Persistent operator memory for this lane. Not part of the append-only ledger.

## Identity

- **lane_id:** `laptop-calibration-0014-0026`
- **branch:** `fm/holusight-avo-laptop-calibration-0014-0026`
- **experiment_id_range:** `0014`–`0026`
...
- **last_manifest_verify:** `2026-08-28T06:13:00Z` (fetched `origin/fm/holusight-avo-setup-v1`, canonical hash verified)
...
experiment ID `0014` when calibration work starts.
