...
Cohesion: 0.18
Nodes (14): _fetch_landing_page(), _load_vercel_config(), Deployment regression tests for holusight.com static site., Vercel must serve a static entry point or holusight.com returns 404., Key marketing/docs pages must exist for holusight.com navigation., Keep Vercel deploy as a static landing page, not a Streamlit/FastAPI build., Marketing copy must not claim planned or unverified capabilities., Docker Compose's normalized model must protect the customer boundary. (+6 more)
