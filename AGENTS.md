...
| `src/codesight/trusted_eval_launcher.py` | Supervisor-owned G2 acceptance boundary: held authority/record descriptors, atomic replay markers, nested OS sandboxes, launcher-only receipt construction, and held-directory persistence. Advisory only. See spec 023 and ADR-0019. |
