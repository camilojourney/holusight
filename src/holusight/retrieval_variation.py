...
RETRIEVAL_SOURCE_PATH = Path("src/holusight/retrieval_variation.py")
PRODUCTION_SELECTOR_SOURCE_PATH = Path("src/holusight/cli_axi.py")
PROVIDER_MODELS_SOURCE_PATH = Path("src/holusight/axi_providers.py")
CONTROL_STORAGE_SOURCE_PATH = Path("src/holusight/control_storage.py")
