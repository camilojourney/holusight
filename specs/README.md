...
| 023 | [Launcher Attestation and Receipt Adversarial Vectors](023-launcher-attestation-receipt-adversarial-vectors.md) | Test-design report; implementation blocked | Local-only |
